# A Country You Love and Do Not Live In
### Albania, its diaspora, and the economics of belonging from elsewhere

---

## Introduction: a paradox I was born into
...
## 1. Historical context: isolation, opening, collapse
...
## 3. Remittances, vacation flows, and the diaspora as macro input
...
## 5. Openness, currency, euroization
...
## 6. Why the emigrants do not return
...
## 7. A counterfactual: what if the diaspora came back?
...
## 8. Philosophical coda: belonging without residence
...
### Cited and directly used in this paper

* Barjaba, J. (2018), *Exploring Transnational Entrepreneurship Among Albanian Migrants and Returnees*, PhD thesis in Migration Studies, School of Global Studies, University of Sussex (supervisor: Prof. Russell King). Available via Sussex Research Online: http://sro.sussex.ac.uk/. Used here for: the consumption-to-investment shift in remittance behavior (chapter 6), the empirical profile of return migrants 2009 to 2013 drawing on INSTAT and IOM data (chapter 3.8), and the qualitative documentation of reintegration challenges including bureaucratic corruption.
* INSTAT and International Organization for Migration (2013), *Return Migration and Reintegration in Albania*, the national survey on which Barjaba 2018 and most subsequent work draw.
* Hirschman, A. O. (1970), *Exit, Voice, and Loyalty: Responses to Decline in Firms, Organizations, and States*, Harvard University Press. Used here as the framing of the exit-loyalty paradox.
* Anderson, B. (1983), *Imagined Communities: Reflections on the Origin and Spread of Nationalism*, Verso. Used in the philosophical coda.
* Banfield, E. C. (1958), *The Moral Basis of a Backward Society*, Free Press. Cited critically in the trust section.
* King, R. (2000), "Generalizations from the history of return migration", in B. Ghosh (ed.), *Return Migration: Journey of Hope or Despair?*, IOM and UN. Source of the "great unwritten chapter" quotation.

### Recommended for additional empirical depth

* World Bank, *Migration and Remittances Factbook* (most recent edition), for the remittance to GDP series.
* Bank of Albania, Balance of Payments statistical reports, for official BoP figures and the lek to euro exchange rate series.
* INSTAT (Albanian Institute of Statistics), 2023 Census results, for the resident population data.
* King, R. and Vullnetari, J., *Albania: A Country Profile of International Migration*, and subsequent joint papers from 2003 onward, for the standard demographic and migration reference framework.
* Vehbiu, A. and Devole, R., *La scoperta dell'Albania*, Paoline (1996 and later editions), Italian language standard reference on the 1991 arrivals.
* European Values Study, latest wave, for the trust variables and cross country comparison.
* Council of Europe and MONEYVAL reports on Albania, for the grey economy section, to be handled with appropriate methodological caution.

---

*Note for the author: the personal voice passages are written to be modular. They can be tightened or expanded depending on the academic register your supervisor expects. If the paper is for an economics journal, you may want to compress the autobiographical opening to a single paragraph and move the philosophical coda to a brief discussion section. If the paper is for a social science or interdisciplinary venue, the current balance is roughly appropriate.*
